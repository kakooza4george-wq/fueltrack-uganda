...
import {
  LayoutDashboard, Building2, Clock, Truck, ShoppingCart,
  Receipt, Users, BarChart3, Settings, Fuel,
...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-blue-900 flex flex-col z-30 shadow-xl">
      <div className="flex items-center gap-3 px-5 py-5 border-b border-blue-800">
        <div className="w-9 h-9 bg-amber-400 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        <p className="text-blue-400 text-[10px] font-bold uppercase tracking-widest px-5 mb-2">
          Main Menu
        </p>
      ...
      <div className="px-5 py-4 border-t border-blue-800">
        <p className="text-blue-400 text-xs font-medium">FuelTrack v1.0</p>
        <p className="text-blue-600 text-xs mt-0.5">Main Branch System</p>
      </div>
    </aside>
  );
}